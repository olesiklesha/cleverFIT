...
import './workouts-side-panel-form.css';

type Props = {
    setDisabled: (isDisabled: boolean) => void;
    form: FormInstance<WorkoutsFormProps>;
};

export const WorkoutsSidePanelForm: React.FC<Props> = ({ form, setDisabled }) => {
    const { trainingList, trainings, currTraining } = useAppSelector(workoutsSelector);
    ...
    const onChange = () => {
        const isDisabled = !isFormValid(form.getFieldsValue());
    ...
    return (
        <Form
            ...
            className='add-exercise-form workouts-form'
        >
            <div className='workout-info'>
                <Form.Item name='trainingName'>
                    <Select
                        placeholder='Выбор типа тренировки'
                        options={getTrainingNameOptions(trainingList)}
                        disabled={Boolean(currTraining)}
